<?php
	...
	$conn = new mysqli(hostname, username, password, db_name) or die ("could not connect to mysql");
			...
			<div class = "row">
				<div class = "col-md-9">
			<?php
				$string = str_replace('%20', ' ', $_SESSION['author']);

				$sql = "SELECT id, title, author, date, text, image, genre, tags FROM articles WHERE author LIKE ? ORDER BY date DESC LIMIT 10";
