	    ...
	    <div class="container">
	    	<div id="myCarousel" class="carousel slide hero-spacer" data-ride="carousel">
			  ...
			  <ol class="list-group col-sm-4">
			    <li data-target="#myCarousel" data-slide-to="0" class="list-group-item active"><h4>New York</h4></li>
			    <li data-target="#myCarousel" data-slide-to="1" class = "list-group-item"><h4>New York</h4></li>
			    <li data-target="#myCarousel" data-slide-to="2" class = "list-group-item"><h4>New York</h4></li>
			    <li data-target="#myCarousel" data-slide-to="3" class = "list-group-item"><h4>New York</h4></li>
			    <li data-target="#myCarousel" data-slide-to="4" class = "list-group-item"><h4>New York</h4></li>
			  </ol>
			  ...
			  <div class="item">
			      <img src="img/image5.jpg" alt="Los Angeles" class = "centered-and-cropped">
			      <div class="carousel-caption">
			        <h3>LA</h3>
			        <p>Even though the traffic was a mess, we had the best time.</p>
			      </div> 
